                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              _buildEditableRow("name", Icons.person),
                              _buildEditableRow("password", Icons.lock),
                              _buildEditableRow("phone", Icons.phone),
                              _buildEditableRow("email", Icons.email),
                              _buildEditableRow("gender", Icons.male),
                            ],
                          ),
                        ),
                      ),
